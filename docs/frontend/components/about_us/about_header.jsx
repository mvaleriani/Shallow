...
class AboutHeader extends React.Component {
  render() {
    return (
        <section className="header-5 flex flex-align-center o-hidden p-x-20 min-h-350" data-cu-height="45%" style={{ backgroundImage:"url(https://github.com/mvaleriani/Shallow/blob/master/docs/app/assets/images/MichaelCoding.jpg?raw=true)", minHeight:"648px", position:"relative"}}>
